...
"""
Description:
    This program prompts the user for a series of integers (entered as comma-separated values)
    and stores only the values between 1 and 100 (inclusive) in a list. It then displays the resulting list.
"""
