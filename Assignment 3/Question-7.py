...
This program implements a class called Employee with attributes such as empid, name, address,
contact_number, spouse_name, number_of_child, and salary. It allows input for multiple employees,
writes the data to a CSV file, and displays employee details when requested.
The program also demonstrates the use of try/except for exception handling.
'''
